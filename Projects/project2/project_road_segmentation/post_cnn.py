...
from helpers.data_helpers import extract_data_model_name, load_img_gt
...
def train_post(model_name, post_name='dummy.h5'):
	...
	# load dataset
	imgs, gts = load_img_gt([1,100])
	data, labels = extract_data_model_name(model_name, PATCH_SIZE_FIRST, PATCH_WINDOW_FIRST, IMAGE_SIZE_FIRST, imgs, gts, PATCH_SIZE, PATCH_WINDOW, IMAGE_SIZE)
