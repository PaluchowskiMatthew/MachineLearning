...
def train_cnn(model_name='dummy.h5', two=True, three=True):
	...
	data = extract_d([1,NUMBER_IMGS], train_data_filename, "satImage_%.3d", IMG_PATCH_SIZE, IMG_WINDOW, 400)
	labels = extract_l([1, NUMBER_IMGS], train_labels_filename, IMG_PATCH_SIZE, IMG_WINDOW)
